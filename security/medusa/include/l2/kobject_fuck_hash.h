...
/* Hash name and digest size definitions based on the selected hashing function in Kconfig */
		...
		#error "You have selected Blake2b for FUCK hash, but it is not configured to be builtin."
    #endif
    ...
    #define FUCK_HASH_DIGEST_SIZE BLAKE2B_512_HASH_SIZE
		...
		#error "You have selected Blake2s for FUCK hash, but it is not configured to be builtin."
    #endif
    ...
    #define FUCK_HASH_DIGEST_SIZE BLAKE2S_256_HASH_SIZE
		...
		#error "You have selected sha256 for FUCK hash, but it is not configured to be builtin."
    #endif
    ...
    #define FUCK_HASH_DIGEST_SIZE SHA256_DIGEST_SIZE
		...
		#error "You have selected sha512 for FUCK hash, but it is not configured to be builtin."
    #endif
    #include <crypto/sha2.h>
    ...
    #define FUCK_HASH_DIGEST_SIZE SHA512_DIGEST_SIZE
		...
		#error "You have selected sha3 for FUCK hash, but it is not configured to be builtin."
    #endif
...
#else
    #error "You have not selected any hash function to be used in the FUCK module."
#endif
